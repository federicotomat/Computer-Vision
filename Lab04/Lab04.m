...
% saturazione e valore / luminosit� invece della rappresentazione RGB. 
% La tonalit� � il colore dell'immagine, la saturazione � la purezza del colore della tonalit� 
% e il valore � la forza della tonalit�. 
...
for i=1:6
    ...
    printFigure(6, 3, {imgHSV(:,:,1,i),imgRGB(:,:,1,i),imgHSV(:,:,2,i),imgRGB(:,:,2,i),...
        imgHSV(:,:,3,i),imgRGB(:,:,2,i),imgRGB(:,:,3,i)} , {1 1 1 1 1 1}, {title{i}(1),title{i}(4),title{i}(2),...
