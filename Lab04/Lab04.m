...
%                                                                                       
% %     title2{i} = {['Box for image number ' num2str(375+i)]};                                                                                  
% %     imgBoxed{i} = colorBoundingBox(imgRGB(:,:,:,i), method, 200, imgType);                                                                                 
% end
%  
% 
% 
...
% end
% 
% %print the detected box
% % printFigure(6, 3, imgBoxed, {3 3 3 3 3 3}, title, 0);
